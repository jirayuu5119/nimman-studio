      ...
      <article className="mx-auto max-w-3xl rounded-[2rem] border border-stone-200 bg-white p-6 shadow-[0_20px_80px_rgba(0,0,0,0.06)] md:p-10">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-stone-600">
          ...
          <section>
            ...
            <p className="mt-2">
              เก็บข้อมูลระหว่างที่จำเป็นต่อการให้บริการ การตรวจสอบบัญชี และข้อกำหนดทางธุรกิจ
              เมื่อพ้นระยะเวลาที่กำหนด ระบบสามารถลบรูปสลิปและทำข้อมูลระบุตัวบุคคลให้ไม่สามารถ
              เชื่อมโยงกลับได้ โดยคงเฉพาะข้อมูลสรุปที่จำเป็นต่อรายงานทางธุรกิจ
            </p>
          </section>
